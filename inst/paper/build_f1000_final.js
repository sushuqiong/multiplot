...
C.push(body("Zenodo: ggmultiplot — Extended data for manuscript submission. https://doi.org/10.5281/zenodo.21137145. The Zenodo archive (sushuqiong/multiplot-v0.1.0.zip) contains the following extended data files under the inst/paper/ directory: (1) table1_style_ontology.md — complete 10-software x 15-attribute ontology mapping across all five dimensions. (2) table2_compliance_assessment.md — full CVD safety, grayscale fidelity, and CMYK compatibility evaluation with CIELAB L* values and per-colour gamut analysis. (3) verification_log.md — per-parameter evidence tracking across 120 dimensions with status indicators. These files are also browsable directly from the GitHub repository. Data are available under the terms of the Creative Commons Attribution 4.0 International license (CC-BY 4.0)."));
